...
![/img/ssb-blessed-dashboard.gif](/img/ssb-blessed-dashboard.gif)

---

### Simple Whois

[Simple Whois](https://github.com/pfraze/ssb-simple-whois) shows how to do materialization by constructing profiles for each user, focusing primarily on the mapping of petnames to feed-IDs.
It does this by looking at the `type: about` messages, and ranking them by the local users' trust-graph.
If there are conflicts, `simple-whois` will let the user know.

**[Learn more in the README.](https://github.com/pfraze/ssb-simple-whois)**
...
[Blogbot](https://github.com/pfraze/blogbot) shows how you can use SSB to control automated systems.
The application runs an HTTP server which renders `type: post` messages as blog posts.
To add a post, you mention the blogbot.
If it follows you, it will add the post to the site.

**[Learn more in the README.](https://github.com/pfraze/blogbot)**

![/img/blogbot.gif](/img/blogbot.gif)
